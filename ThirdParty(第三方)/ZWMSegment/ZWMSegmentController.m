...
@property (nonatomic, readwrite) NSUInteger markindex;
...
- (void)segmentPageSetting {
    _segmentView = [[ZWMSegmentView alloc] initWithFrame:CGRectMake(0, 0, _size.width, ZWMSegmentHeight) titles:_titles];
...
-(void)setShowSegmentViewLine:(BOOL)showSegmentViewLine{
    _showSegmentViewLine = showSegmentViewLine;
    
    UIView * lineView = [[UIView alloc]initWithFrame:CGRectMake(0, ZWMSegmentHeight-1, _size.width, 1)];
